...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button[name='reviseok']").click(function () {
                //searchTitle  searchTypeid searchFlag searchStartcreattime searchEndcreattime
                location.href = "newsAction?flag=reviseok&newsId="+$(this).val()+"&pageNow=${requestScope.pageNow}&showRowCount=${showRowCount}";



            })
            $("button[name='revise']").click(function () {
                <%--alert(${requestScope.pageNow})--%>
                location.href = "newsAction?flag=revise&newsId="+$(this).val()+"&pageNow=${requestScope.pageNow}&showRowCount=${showRowCount}";
                <%--//通过ajax向后台传id，后台通过id找出修改的当前用户信息，并返回前台--%>
                <%--$.ajax({--%>
                    <%--type:"get",--%>
                    <%--dataType : "json",--%>
                    <%--url : "${pageContext.request.contextPath}/newsAction",--%>
                    <%--data : {--%>
                        <%--updateId : $(this).val(),--%>
                        <%--flag : "revise"--%>
                    <%--},--%>
...
">
    ...
    padding-left: 20px;">
                            ...
                            <form action="newsAction?flag=superCompoundSearch&pageNow=${requestScope.pageNow }&showRowCount=${showRowCount}" method="post" style="margin-left: 70px">
    ...
    font-weight: bold;">时间范围</p> <input type="text" name="searchStartcreattime" id="startcreattime"
                                        value="${searchStartcreattime}" placeholder="开始时间..."
                                        style="color: white;width: 150px;"/>
                                <input type="text" name="searchEndcreattime" id="endcreattime"
                                       value="${searchEndcreattime}"
    ...
    color: white;">
                        ...
                        <table id="fresh-table" class="table">
                            ...
                            <form action="${pageContext.request.contextPath}/newsAction?flag=batch&superCompoundSearch=superCompoundSearch&pageNow=${requestScope.pageNow }&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}"
                                  method="post">

                                </c:if>
                                <c:if test="${no eq issearch}">
                                <form action="${pageContext.request.contextPath}/newsAction?flag=batch&pageNow=${requestScope.pageNow }&showRowCount=${showRowCount}"
                                      method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${ok eq issearch}">
                                                ...
                                                <button type="button" name="reviseok" id="btn" value="${list.id}"
                                                        style="background-color: cadetblue;">修改
                                                </button>
                                                <button type="button"
                                                        onclick="window.location.href='newsAction?flag=delete&superCompoundSearch=superCompoundSearch&id=${list.id }&pageNow=${requestScope.pageNow }&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}'"
                                                        style="    background-color: slateblue;">删除
                                                </button>

                                            </c:if>
                                            <c:if test="${no eq issearch}">
                                                <button type="button" name="revise" id="btn" value="${list.id}"
                                                        style="background-color: cadetblue;">修改
                                                </button>
                                                <button type="button"
                                                        onclick="window.location.href='newsAction?flag=delete&id=${list.id }&pageNow=${requestScope.pageNow }&showRowCount=${showRowCount}'"
                                                        style="    background-color: slateblue;">删除
                                                </button>
                        ...
                        <div class="toolbar">
                            ...
                            <script type="text/javascript">
                                window.onload = function () {
                                    ...
                                    showRowCount.onchange = function () {
                                        if (${ok eq issearch}) {
                                            location.href = "${pageContext.request.contextPath}/newsAction?flag=superCompoundSearch&showRowCount=" + this.value + "&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}";
                                        } else {

                                            location.href = "${pageContext.request.contextPath}/newsAction?flag=superSearchNews&showRowCount=" + this.value;
                                        }
                                    }
                            ...
                            <c:if test="${pageNow != 1}">
                                <c:if test="${ok eq issearch}">
                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superCompoundSearch&pageNow=1&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}"
                                       style="color: white;margin-left: 20px;width: 20px;height: 20px;font-size: 18px;">首页</a>

                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superCompoundSearch&pageNow=${requestScope.pageNow-1 }&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}"
                                       style="color: white;margin-left: 20px;width: 20px;height: 20px;font-size: 18px;">上一页</a>
                                </c:if>
                                <c:if test="${no eq issearch}">
                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superSearchNews&pageNow=1&showRowCount=${showRowCount}"
                                       style="color: white;margin-left: 20px;width: 20px;height: 20px;font-size: 18px;">首页</a>

                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superSearchNews&pageNow=${requestScope.pageNow-1 }&showRowCount=${showRowCount}"
                                       style="color: white;margin-left: 20px;width: 20px;height: 20px;font-size: 18px;">上一页</a>
                                </c:if>
                            ...
                            <c:if test="${pageNow>3}">
                                ...
                                <c:if test="${ok eq issearch}">
                                    ...
                                    text-align: center;
                                    border-radius: 35px;'
                                               href="${pageContext.request.contextPath }/newsAction?flag=superCompoundSearch&pageNow=${i }&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}">${i }</a>
                                        </c:if>
                                        <c:if test="${i!=requestScope.pageNow }">
                                ...
                                <c:if test="${no eq issearch}">
                                    ...
                                    text-align: center;
                                    border-radius: 35px;'
                                               href="${pageContext.request.contextPath }/newsAction?flag=superSearchNews&pageNow=${i }&showRowCount=${showRowCount}">${i }</a>
                                        </c:if>
                                        <c:if test="${i!=requestScope.pageNow }">
                                            <a style="display:inline-block;color: white;margin-left: 20px;width: 35px;
                                    height: 35px;
                            ...
                            <c:if test="${(requestScope.pageNow != pageCount) && pageCount != 0}">
                                <c:if test="${ok eq issearch}">
                                    ...
                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superCompoundSearch&pageNow=${requestScope.pageCount }&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}"
                                ...
                                <c:if test="${no eq issearch}">
                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superSearchNews&pageNow=${requestScope.pageNow+1 }&showRowCount=${showRowCount}"
                                       style="color: white;margin-left: 20px;width: 20px;height: 20px;font-size: 18px;">下一页</a>
                                    <a href="${pageContext.request.contextPath }/newsAction?flag=superSearchNews&pageNow=${requestScope.pageCount }&showRowCount=${showRowCount}"
                                       style="color: white;margin-left: 20px;width: 20px;height: 20px;font-size: 18px;">尾页</a>
                                </c:if>
                            </c:if>
                            <c:if test="${(requestScope.pageNow == pageCount) || pageCount == 0}">
                            ...
                            <c:if test="${ok eq issearch}">
                                <form action="${pageContext.request.contextPath }/newsAction?flag=superCompoundSearch&pageNow=${requestScope.pageNow }&showRowCount=${showRowCount}&searchTitle=${searchTitle}&searchTypeid=${searchTypeid}&searchFlag=${searchFlag}&searchStartcreattime=${searchStartcreattime}&searchEndcreattime=${searchEndcreattime}"
                            ...
                            <c:if test="${no eq issearch}">
                                <form action="${pageContext.request.contextPath }/newsAction?flag=superSearchNews&showRowCount=${showRowCount}"
                                      method="post" style="display: inline-block">
                                    <input type="text" name="page" style="width: 50px;margin-left: 20px;color: white;"
                                           placeholder="       页"><input
                                        type="submit" value="跳转" style="width: 50px;color: white">
